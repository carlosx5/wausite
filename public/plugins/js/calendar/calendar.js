...
var FullCalendar = (function (e) {
    ...
    function Er(e, t, n) {
        var r = n.dateEnv,
            ...
            i = t;
        return (
            e ? ((i = lt(i)), (i = r.add(i, o.defaultAllDayEventDuration))) : (i = r.add(i, o.defaultTimedEventDuration)), i
        );
    }
    function Sr(e, t, n, r) {
        var o = Qn(e.defs, t),
                ...
                (e.prototype._splitInteraction = function (e) {
                    ...
                    if (e) {
                        var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
                            ...
                            i = function (r) {
                                t[r] ||
                                    (t[r] = { affectedEvents: n[r] || eo, mutatedEvents: o[r] || eo, isEvent: e.isEvent });
                            };
                        for (var a in n) i(a);
                        for (var a in o) i(a);
                    }
    ...
    function Ya(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
                n.push(
                    _o("col", { style: { width: "shrink" === a.width ? Za(t) : a.width || "", minWidth: a.minWidth || "" } })
                );
    ...
    function os(e) {
        return _o(
            ...
            _o(
                ...
                _o("div", { className: "fc-event-title fc-sticky" }, e.event.title || _o(xo, null, "Â "))
            )
        );
    }
    var is = function (e) {
            ...
            (o.subjectEl = null),
                ...
                (o.handleDragEnd = function (e) {
                    if (o.isDragging) {
                        ...
                        if (
                            (o.clearDrag(),
                            t.emitter.trigger("eventDragStop", { el: o.subjectEl, event: c, jsEvent: e.origEvent, view: n }),
                            s)
                        ) {
                            if (a === t) {
                    ...
                    (this.handleDragEnd = function (e) {
                        ...
                        if ((n.clearDrag(), o && i)) {
                            ...
                            if (
                                (o.emitter.trigger(
                                    "drop",
                                    r(r({}, Ws(a.dateSpan, o)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: s })
                                ),
                                l.create)
                            ) {
                                var u = Sn(i);
    ...
    function ll(e) {
        return _o(
            ...
            e.timeText && _o("div", { className: "fc-event-time" }, e.timeText),
            _o("div", { className: "fc-event-title" }, e.event.title || _o(xo, null, "Â "))
        );
    }
    var ul = (function (e) {
        function t() {
        ...
        eventSourceDefs: [
            {
                ...
                fetch: function (e, t, n) {
                    ...
                    if (l) {
                        ...
                        n({ message: "Specify a googleCalendarApiKey. See http://fullcalendar.io/docs/google_calendar/" });
                },
            },
        ],
