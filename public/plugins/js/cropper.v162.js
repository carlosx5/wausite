            ...
            .forEach(function (t) {
                ...
                Et ||
                    ((e = i.listeners) &&
                        e[t] &&
                        e[t][a] &&
                        ((o = e[t][a]), delete e[t][a], 0 === Object.keys(e[t]).length && delete e[t], 0 === Object.keys(e).length) &&
                        delete i.listeners),
    ...
    var t = {
            ...
            limitCanvas: function (t, e) {
                ...
                t &&
                    ...
                    1 < h
                        ? ((t = Math.max(t, a.width)), (i = Math.max(i, a.height)), 3 === h && (t < i * r ? (t = i * r) : (i = t / r)))
                        : 0 < h &&
                          (t
        ...
        e = {
            bind: function () {
                ...
                l(e.cropstart) && b(t, at, e.cropstart),
                    ...
                    e.zoomable && e.zoomOnWheel && b(i, "wheel", (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
        ...
        St = {
            ...
            dblclick: function () {
                ...
                this.disabled ||
                    ...
                    this.setDragMode(
                        ((t = this.dragBox), (e = Q), (t.classList ? t.classList.contains(e) : -1 < t.className.indexOf(e)) ? J : F)
                    );
            },
            wheel: function (t) {
                var e = this,
            ...
            cropStart: function (t) {
                ...
                this.disabled ||
                    ...
                    dt.test(a) &&
                        ...
                        (t.preventDefault(), (this.action = a), (this.cropping = !1), a === U) &&
            ...
            cropMove: function (t) {
                ...
                !this.disabled &&
                    i &&
                    ((e = this.pointers), t.preventDefault(), !1 !== y(this.element, it, { originalEvent: t, action: i })) &&
                    (t.changedTouches
                        ? z(t.changedTouches, function (t) {
            ...
            change: function (t) {
                ...
                switch (d) {
                    ...
                    case T:
                        D.y <= 0 && (m <= b || (l && (p <= w || y <= f)))
                            ? (M = !1)
                            : (e(T), (g -= D.y), (m += D.y), g < 0 && ((d = O), (m -= g = -g)), l && (p += (s.width - (u = g * l)) / 2));
                        break;
                    case k:
                        D.x <= 0 && (p <= w || (l && (m <= b || x <= v)))
                            ? (M = !1)
                            : (e(k), (u -= D.x), (p += D.x), u < 0 && ((d = B), (p -= u = -u)), l && (m += (s.height - (g = u / l)) / 2));
                        break;
                    case O:
                        0 <= D.y && (x <= v || (l && (p <= w || y <= f)))
                            ? (M = !1)
        ...
        At = {
            ...
            getCropBoxData: function () {
                var t,
                    e = this.cropBoxData;
                return (t = this.ready && this.cropped ? { left: e.left, top: e.top, width: e.width, height: e.height } : t) || {};
            },
                            ...
                            1 < a &&
                                ((this.url = (function (t, e) {
                                    for (var i = [], a = new Uint8Array(t); 0 < a.length; )
                                        i.push(Yt.apply(null, yt(a.subarray(0, 8192)))), (a = a.subarray(8192));
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.element,
                                ...
                                a = e,
                                n =
                                    (this.options.checkCrossOrigin && Lt(e) && ((i = i || "anonymous"), (a = zt(e))),
                                    (this.crossOrigin = i),
