        ...
        var t = {
                                ...
                                this.quill.on(r.Ay.events.EDITOR_CHANGE, (t, e, n, i) => {
                                    t === r.Ay.events.SELECTION_CHANGE
                                        ...
                                        : t === r.Ay.events.TEXT_CHANGE &&
                                          (this.ignoreChange ||
                                              (this.options.userOnly && i !== r.Ay.sources.USER ? this.transform(e) : this.record(e, n)),
                ...
                6142: function (t, e, n) {
                    ...
                    var x = class {
                            ...
                            applyDelta(t) {
                                ...
                                return (
                                    ...
                                    l.reduce(
                                        (t, e) =>
                                            "number" == typeof e.delete ? (this.scroll.deleteAt(t, e.delete), t) : t + s.Op.length(e),
                                        0
                                    ),
                    ...
                    class I {
                        ...
                        static import(t) {
                            return (
                                null == this.imports[t] && C.error(`Cannot import ${t}. Are you sure it was registered?`), this.imports[t]
                            );
                        }
                        static register() {
                                ...
                                return (function (t, r) {
                                    ...
                                    for (var f = i - o, p = f % 2 != 0, g = 0, m = 0, b = 0, y = 0, v = 0; v < l; v++) {
                                        for (var A = -v + g; A <= v - m; A += 2) {
                                            for (
                                                var x = a + A,
                                                    N = (_ = A === -v || (A !== v && u[x - 1] < u[x + 1]) ? u[x + 1] : u[x - 1] + 1) - A;
                                        ...
                                        for (var E = -v + b; E <= v - y; E += 2) {
                                            for (
                                                var w,
                                                    q = a + E,
                                                    k = (w = E === -v || (E !== v && h[q - 1] < h[q + 1]) ? h[q + 1] : h[q - 1] + 1) - E;
                ...
                5123: function (t, e, n) {
                    ...
                    var o = s,
                        ...
                        L = function t(e, n, r, i, s) {
                            return (
                                e === n ||
                                (null == e || null == n || (!(0, _.A)(e) && !(0, _.A)(n)) ? e != e && n != n : k(e, n, r, i, t, s))
                            );
                        },
                        S = function (t, e) {
                            return L(t, e);
                                    ...
                                    i = o.length > 3 && "function" == typeof i ? (r--, i) : void 0,
                                        s &&
                                            (function (t, e, n) {
                                                ...
                                                var r = typeof e;
                                                return (
                                                    !!("number" == r ? (0, y.A)(n) && (0, H.A)(e, n.length) : "string" == r && (e in n)) &&
                                                    (0, c.A)(n[e], t)
                                                );
                                            })(e[0], e[1], s) &&
                                            ((i = r < 3 ? void 0 : i), (r = 1)),
